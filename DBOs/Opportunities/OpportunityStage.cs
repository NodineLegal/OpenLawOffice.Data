...
namespace OpenLawOffice.Data.DBOs.Opportunities
{
    ...
    public class OpportunityStage : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(OpportunityStage), new ColumnAttributeTypeMapper<OpportunityStage>());
            Mapper.CreateMap<OpportunityStage, Common.Models.Opportunities.OpportunityStage>()
            ...
            Mapper.CreateMap<Common.Models.Opportunities.OpportunityStage, OpportunityStage>()
