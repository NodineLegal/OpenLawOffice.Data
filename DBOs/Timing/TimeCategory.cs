...
namespace OpenLawOffice.Data.DBOs.Timing
{
    ...
    public class TimeCategory : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(TimeCategory), new ColumnAttributeTypeMapper<TimeCategory>());
            Mapper.CreateMap<DBOs.Timing.TimeCategory, Common.Models.Timing.TimeCategory>()
            ...
            Mapper.CreateMap<Common.Models.Timing.TimeCategory, DBOs.Timing.TimeCategory>()
