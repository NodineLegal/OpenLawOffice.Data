...
namespace OpenLawOffice.Data.DBOs.Activities
{
    ...
    public class ActivityTask : ActivityBase
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(ActivityTask), new ColumnAttributeTypeMapper<ActivityTask>());
            Mapper.CreateMap<ActivityTask, Common.Models.Activities.ActivityTask>()
            ...
            Mapper.CreateMap<Common.Models.Activities.ActivityTask, ActivityTask>()
