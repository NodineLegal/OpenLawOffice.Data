...
namespace OpenLawOffice.Data.DBOs.Activities
{
    ...
    public class ActivityEmail : ActivityCorrespondenceBase
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(ActivityEmail), new ColumnAttributeTypeMapper<ActivityEmail>());
            Mapper.CreateMap<ActivityEmail, Common.Models.Activities.ActivityEmail>()
            ...
            Mapper.CreateMap<Common.Models.Activities.ActivityEmail, ActivityEmail>()
