...
namespace OpenLawOffice.Data.DBOs.Activities
{
    ...
    {
        [ColumnMapping(Name = "phone_number")]
        public string PhoneNumber { get; set; }

        public void BuildMappings()
        {
            Dapper.SqlMapper.SetTypeMap(typeof(ActivityPhonecall), new ColumnAttributeTypeMapper<ActivityPhonecall>());
            Mapper.CreateMap<ActivityPhonecall, Common.Models.Activities.ActivityPhonecall>()
            ...
            Mapper.CreateMap<Common.Models.Activities.ActivityPhonecall, ActivityPhonecall>()
