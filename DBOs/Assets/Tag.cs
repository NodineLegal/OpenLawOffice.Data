...
namespace OpenLawOffice.Data.DBOs.Assets
{
    ...
    [Common.Models.MapMe]
    public class Tag : Core // Table : asset_tag
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(Tag), new ColumnAttributeTypeMapper<Tag>());
            Mapper.CreateMap<DBOs.Assets.Tag, Common.Models.Assets.Tag>()
            ...
            Mapper.CreateMap<Common.Models.Assets.Tag, DBOs.Assets.Tag>()
