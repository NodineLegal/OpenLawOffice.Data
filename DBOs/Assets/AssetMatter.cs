...
namespace OpenLawOffice.Data.DBOs.Assets
{
    ...
    public class AssetMatter : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(AssetMatter), new ColumnAttributeTypeMapper<AssetMatter>());
            Mapper.CreateMap<DBOs.Assets.AssetMatter, Common.Models.Assets.AssetMatter>()
            ...
            Mapper.CreateMap<Common.Models.Assets.AssetMatter, DBOs.Assets.AssetMatter>()
