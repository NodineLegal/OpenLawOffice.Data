...
namespace OpenLawOffice.Data.DBOs.Leads
{
    ...
    public class LeadSourceType : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(LeadSourceType), new ColumnAttributeTypeMapper<LeadSourceType>());
            Mapper.CreateMap<LeadSourceType, Common.Models.Leads.LeadSourceType>()
            ...
            Mapper.CreateMap<Common.Models.Leads.LeadSourceType, LeadSourceType>()
