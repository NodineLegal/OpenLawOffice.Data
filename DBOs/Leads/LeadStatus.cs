...
namespace OpenLawOffice.Data.DBOs.Leads
{
    ...
    public class LeadStatus : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(LeadStatus), new ColumnAttributeTypeMapper<LeadStatus>());
            Mapper.CreateMap<LeadStatus, Common.Models.Leads.LeadStatus>()
            ...
            Mapper.CreateMap<Common.Models.Leads.LeadStatus, LeadStatus>()
