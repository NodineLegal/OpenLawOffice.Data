...
namespace OpenLawOffice.Data.DBOs.Matters
{
    ...
    public class CourtGeographicalJurisdiction : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(CourtGeographicalJurisdiction), new ColumnAttributeTypeMapper<CourtGeographicalJurisdiction>());
            Mapper.CreateMap<DBOs.Matters.CourtGeographicalJurisdiction, Common.Models.Matters.CourtGeographicalJurisdiction>()
            ...
            Mapper.CreateMap<Common.Models.Matters.CourtGeographicalJurisdiction, DBOs.Matters.CourtGeographicalJurisdiction>()
