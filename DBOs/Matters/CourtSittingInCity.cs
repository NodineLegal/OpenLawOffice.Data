...
namespace OpenLawOffice.Data.DBOs.Matters
{
    ...
    public class CourtSittingInCity : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(CourtSittingInCity), new ColumnAttributeTypeMapper<CourtSittingInCity>());
            Mapper.CreateMap<DBOs.Matters.CourtSittingInCity, Common.Models.Matters.CourtSittingInCity>()
            ...
            Mapper.CreateMap<Common.Models.Matters.CourtSittingInCity, DBOs.Matters.CourtSittingInCity>()
