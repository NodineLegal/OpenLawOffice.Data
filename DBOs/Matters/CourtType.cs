...
namespace OpenLawOffice.Data.DBOs.Matters
{
    ...
    public class CourtType : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(CourtType), new ColumnAttributeTypeMapper<CourtType>());
            Mapper.CreateMap<DBOs.Matters.CourtType, Common.Models.Matters.CourtType>()
            ...
            Mapper.CreateMap<Common.Models.Matters.CourtType, DBOs.Matters.CourtType>()
