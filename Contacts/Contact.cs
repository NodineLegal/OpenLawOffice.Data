...
namespace OpenLawOffice.Data.Contacts
{
    ...
    {
        public static Common.Models.Contacts.Contact Get(
            int id,
            ...
            bool closeConnection = true)
        {
            return DataHelper.Get<Common.Models.Contacts.Contact, DBOs.Contacts.Contact>(
                ...
                new { displayName = displayName }, conn, closeConnection);
        }
        ...
        public static Common.Models.Contacts.Contact Get(
            ...
            string displayName)
        {
            return Get(displayName, t.Connection, false);
        }
        ...
        public static List<Common.Models.Matters.Matter> ListMattersForContact(
            int contactId,
            IDbConnection conn = null, 
            bool closeConnection = true)
        {
        ...
        public static List<Common.Models.Matters.Matter> ListMattersForContact(
            ...
            int contactId)
        {
            return ListMattersForContact(contactId, t.Connection, false);
        }

        public static List<Common.Models.Matters.Matter> ListMattersWhereContactIsBillTo(
            int contactId,
            IDbConnection conn = null, 
            bool closeConnection = true)
        {
        ...
        public static List<Common.Models.Matters.Matter> ListMattersWhereContactIsBillTo(
            ...
            int contactId)
        {
            return ListMattersWhereContactIsBillTo(contactId, t.Connection, false);
        }
        ...
        public static List<Tuple<Common.Models.Matters.Matter, Common.Models.Matters.MatterContact, Common.Models.Contacts.Contact>>
            ...
            Guid matterId)
        {
            return ListMatterRelationshipsForContact(contactId, matterId, t.Connection, false);
        }
        ...
        public static List<Common.Models.Contacts.Contact> List(
            ...
            string displayName)
        {
            return List(displayName, t.Connection, false);
        }
        ...
        public static List<Common.Models.Contacts.Contact> ListEmployeesOnly(
            Transaction t)
        {
            return ListEmployeesOnly(t.Connection, false);
        }
            ...
            bool closeConnection = true)
        {
            ...
            if (conn.Execute("INSERT INTO \"contact\" (" +
                ...
                "@BillingRateId, " +
                "@UtcCreated, @UtcModified, @CreatedByUserPId, @ModifiedByUserPId)", dbo) > 0)
                model.Id = dbo.Id = conn.Query<DBOs.Contacts.Contact>("SELECT currval(pg_get_serial_sequence('contact', 'id')) AS \"id\"").Single().Id;
